...
\usepackage[backend=biber, style=iso-authoryear, maxnames=3, minnames=1, uniquelist=false, uniquename=false]{biblatex}
...
% Forces "et" before the final author to match HEG guidelines
\renewcommand*{\finalnamedelim}{\space et\space}
