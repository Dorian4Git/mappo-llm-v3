...
% ==========================================================================
\section{The Meta-Controller: Discrete Neuro-Symbolic HRL}
...
When a staleness trigger fires, the LLM receives a reflection prompt instead of the standard assignment prompt. This forces the LLM to reason about \emph{why} the previous option failed—typically a missing DAG precondition—before proposing a corrected assignment.
