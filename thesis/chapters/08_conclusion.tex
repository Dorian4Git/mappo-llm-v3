...
This thesis demonstrates that while Large Language Models are profoundly powerful strategic directors for MARL agents, they should not be treated as reliable oracles. Future architectures must balance high-level semantic planning with the constraints of low-level reinforcement learning.